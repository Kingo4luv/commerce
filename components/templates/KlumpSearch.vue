...
/** This is the search results template components */
...
<template>
  <div class="px-4">
    <div
      id="searchResult"
      class="w-full max-w-screen-xl mx-auto mt-6 lg:mt-12 space-y-6 lg:space-y-12"
    >
      <p class="space-x-2 text-black">
        <nuxt-link to="/">Home</nuxt-link><span> > </span> <span class="text-[#868686]">Search Result</span>
      </p>
